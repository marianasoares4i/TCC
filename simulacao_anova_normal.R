...
anova_normal <- stan("/home/mariana/Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/anova_normal_simulacao.stan",
...
saveRDS(anova_normal,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal/result_simulacao_anova_normal.rds")
saveRDS(dados_simulados,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/dados_simulados_anova_normal.rds")
...
## rodando o modelo no stan
anova_normal <- stan("/home/mariana/Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/anova_normal_choy.stan",
                     data=list(X_alpha=X_a,X_beta=X_b,Y=Y,K_alpha=K,K_beta=K,N=N,X_alpha_prev=X_a_prev,
                               X_beta_prev=X_b_prev, K_alpha_prev=K_prev,N_prev=N_prev,K_beta_prev=K_prev),
...
saveRDS(anova_normal,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal/result_choy_anova_normal.rds")
...
View(extract(anova_normal)$y_new)
y_novo<-apply(y_new,MARGIN=2,FUN=median)
saveRDS(anova_normal,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal/result_verral_anova_normal.rds")
...
View(extract(anova_normal)$y_new)
y_novo<-apply(y_new,MARGIN=2,FUN=median)
saveRDS(anova_normal,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal/result_cote_anova_normal.rds")
...
View(extract(anova_normal)$y_new)
y_novo<-apply(y_new,MARGIN=2,FUN=median)
saveRDS(anova_normal,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_normal/result_soa_anova_normal.rds")

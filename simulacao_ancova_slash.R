#### DADOS SIMULADOS MODELO ANCOVA ERRO T ####
rm(list=ls())
library(dplyr)
library(lattice)
library(brms)
...
#### MODELO LOG ANCOVA BAYESIANO ERRO T ####
...
ancova_errot <- stan("/home/mariana/Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/ancova_slash_simulacao.stan",
...
saveRDS(ancova_errot,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_simulacao_ancova_slash.rds")
saveRDS(dados_simulados,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/dados_simulados_ancova_slash.rds")


#### MODELO ANCOVA ERRO T DADOS CHOY ####
n<-18
...
ancova_errot <- stan("/home/mariana/Pessoal/Modelos_tcc_teste_validation/MODELOS USADOS/ancova_slash_choy.stan",
                     data=list(X_alpha=X_a,X_beta=X_b,Y=Y,K_beta=K,N=N,X_alpha_prev=X_b_prev,X_beta_prev=X_a_prev,
                               K_beta_prev=K_prev,N_prev=N_prev),
                     warmup=10000,iter=40000,thin=50,
                     chains=2, control=list(adapt_delta=0.99),cores = getOption("mc.cores", 2))  
...
saveRDS(ancova_errot,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_choy_ancova_slash.rds")

#### MODELO ANCOVA ERRO T DADOS VERRAL ####
n<-10
## dados choy
...
saveRDS(ancova_errot,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_verral_ancova_slash.rds")


#### MODELO ANCOVA ERRO T DADOS COTE ####
n<-10
...
saveRDS(ancova_errot,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_cote_ancova_slash.rds")
...
saveRDS(ancova_errot,file="/home/mariana/Pessoal/Modelos_tcc_teste_validation/modelos_erro_slash/result_soa_ancova_slash.rds")
